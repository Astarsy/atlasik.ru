...
class RegistrationDataStorage{
    ...
    public static function getUserRegistrationData($mail,$db){
        ...
        //В данной версии учетные записи хранятся в БД
        return $db->getUserRegistrationData($mail);

    }
    public static function saveUserRegistrationData($m,$p,$db){
